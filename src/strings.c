...
const u8 gText_ProfBirchMatchCallName[] = _("PROF. KURWA");
...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. KURWA's POKéDEX rating!\pPROF. KURWA: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. KURWA is in trouble!\nRelease a POKéMON and rescue him!");
